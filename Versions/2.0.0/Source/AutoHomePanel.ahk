...
Gui, Add, Tab2, x0 y94 w479 h398 , Grundeinstellungen|Autostart Programme
...
Gui, Add, Button, x310 y140 w90 h28 gCopy, Dateien Kopieren
Gui, Font, s15 cBlack
...
Gui, Add, Text, x252 y189 w182 h38 , Willkommens Nachricht bearbeiten
...
Copy:
FileCopy, "%A_ScripDir%\bin\autorun.inf", %deviceUSB%
FileCopy, "%A_ScripDir%\bin\icon.ico", %deviceUSB%
FileCopy, "%A_ScripDir%\bin\usb.ath", %deviceUSB% 
