...
Menu, Hilfsmenü, Add, Inf&o, MenuHelp
...
Gui, Add, Text, x25 y45 w350 h28, Dateien zum bearbeiten über Menüleiste Öffnen
Gui, Show, w400 h600, AutoHome Editor
return

MenüDateiÖffnen:
Gui, Flash
FileSelectFile, confdir , 3, %A_ScriptDir%, AutoHome Datei Öffnen, AutoHome Dateien (*.ath; *.autohome)
if confdir contains .ath
    gosub, athfile
if confdir contains .autohome
	gosub, autohomefile
